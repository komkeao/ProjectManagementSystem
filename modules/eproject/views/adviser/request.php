...
<br>
    <button type="button" class="btn btn-default pull-right"  style="width: 10%">ล้างฟอร์ม</button>
    <button type="button" class="btn btn-default pull-right"  style="width: 10%">ตกลง</button>
